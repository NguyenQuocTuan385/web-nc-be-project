        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .authorizeHttpRequests(requests -> {
                                        requests
                                                        .requestMatchers(
                                                                        String.format("%s/authentication/register",
                                                                                        apiPrefix),
                                                                        String.format("%s/authentication/refresh",
                                                                                        apiPrefix),
                                                                        String.format("%s/authentication/login",
                                                                                        apiPrefix),
                                                                        String.format("%s/authentication/logout",
                                                                                        apiPrefix),
                                                                        String.format("%s/email/otp", apiPrefix),
                                                                        String.format("%s/users/checkOTP", apiPrefix),
                                                                        String.format("%s/authentication/change-password",
                                                                                        apiPrefix),
                                                                        String.format("%s/authentication/reset-password",
                                                                                        apiPrefix),
                                                                        String.format("%s/locations-client/**",
                                                                                        apiPrefix),
                                                                        String.format("%s/locations-client", apiPrefix),
                                                                        String.format("%s/contracts-client/advertises/**",
                                                                                        apiPrefix),
                                                                        String.format("%s/advertises-client/**",
                                                                                        apiPrefix),
                                                                        String.format("%s/advertises-client",
                                                                                        apiPrefix),
                                                                        String.format("%s/reports-client", apiPrefix),
                                                                        String.format("%s/reports-client/**",
                                                                                        apiPrefix),
                                                                        String.format("%s/report-forms-client/**",
                                                                                        apiPrefix),
                                                                        String.format("%s/report-forms-client",
                                                                                        apiPrefix),
                                                                        String.format("%s/properties-client/**",
                                                                                        apiPrefix),
                                                        ...
                                                        .requestMatchers(
                                                                        ...
                                                                        String.format("%s/report-forms", apiPrefix),
                                                                        String.format("%s/advertise-types/**",
                                                                                        apiPrefix))
                                                        .hasAnyRole(
